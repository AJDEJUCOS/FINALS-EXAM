...
if (isset($_POST['rejectApplicationBtn'])) {
    ...
    $message = "Dear " . $application['username'] . ", Thank you for your interest. Unfortunately, after careful consideration, 
    we regret to inform you that your application has been rejected. We wish you all the best in your future endeavors.";
...
if (isset($_POST['acceptApplicationBtn'])) {
    ...
    $message = "Dear " . $application['username'] . ", Congratulations! We are pleased to inform you that your 
    application has been accepted. We look forward to working with you!";
    $stmt = $pdo->prepare("INSERT INTO messages (from_user_id, to_user_id, message) VALUES (?, ?, ?)");
    $stmt->execute([$_SESSION['user_id'], $application['user_id'], $message]);
